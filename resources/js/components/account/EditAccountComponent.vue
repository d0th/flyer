        ...
        >
            ...
            <p>
                ...
                <select
                    ...
                    required
                >
                    <option v-for="(value, key) in countruSelect" :value="key">{{value}}</option>
                </select>
            </p>
            ...
            <p>
                <label for="city">Адрес эл. почты</label>
                <input
                    id="email"
                    v-model="email"
                    type="email"
            ...
            <p>
                ...
                <vue-phone-number-input
                    ...
                    v-model="phone"
                    required
                    default-country-code="BY"></vue-phone-number-input>
            </p>
            ...
            <p>
                <label for="password_1">Подтвердить пароль</label>
                <input
                    id="password_1"
                    v-model="password_1"
                    type="password"
            ...
            <p>
                <label for="newsletter">Я согласен(на) получать информацию от iflyminsk.by</label>
                <input
                    id="newsletter"
                    v-model="newsletter"
                    type="checkbox"
        ...
        methods: {
            checkForm: function (e) {
                ...
                if (this.password !== this.password_1) {
                    this.errors.push('Не совпадают пароли');
                }
