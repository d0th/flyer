<template>
    <div class="container">
        ...
        >
            ...
            <input id="_token" type="hidden" name="_token" v-model="csrfToken">
            <p>
                ...
                <select
                    ...
                    required
                >
                    <option selected="selected" value="M">Г-н</option>
            ...
            <p>
                <label for="password_1">Я прочитал(а) и согласен(а) с Договором публичной оферты</label>
                <input
                    id="oferta"
                    v-model="oferta"
                    type="checkbox"
            ...
            <p>
                <label for="password_1">Я согласен(на) получать информацию от iflyminsk.by</label>
                <input
                    id="newsletter"
                    v-model="newsletter"
                    type="checkbox"
