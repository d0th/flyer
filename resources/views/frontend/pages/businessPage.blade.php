...
@section('content')
    <main id="corporate">
                ...
                <div class="container">
                    <div class="row fd-c">
                        <div class="corporate__caption">
                            <h2 class="corporate__title">Бизнес встречи</h2>
        ...
        <section class="parties business pt-40">
            <div class="container">
                <div class="parties__title text-center">
                    <h2 class="title__bold">Проведение бизнес встреч</h2>
                </div>
                <div class="row">
        ...
        <section id="corporate__form" class="corporate__form bg-gray pt-60 pb-60">
            @include('.frontend.blocks.form_callback_business')
        </section>
