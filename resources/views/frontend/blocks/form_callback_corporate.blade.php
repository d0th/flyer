...
<div class="container main__form is-active">
    <form id="form" class="form corporate__form sended-form">
        ...
        <div class="formWrap">
            <div class="form__top">
                ...
                <div class="mainform__group group-01">
                    <input type="date" placeholder=" "  class="mainform__control required" name="date" id="date" required>

                    @if(Session::get('locale') == 'en')
                        <label style="top: -18px" for="date" class="mainform__label">Date<span class="required-star">*</span><span class="help-text-wrap none"><span class="help-text">Обязательное поле</span></span></label>
                    @else
            ...
            <div class="footer__bottom">
                ...
                <div class="form__box">
                    ...
                    @if(Session::get('locale') == 'en')
                        <input id="btn" type="button" class="btn submit corporate__submit btn-hover" value="SEND"/>
                    @else
    ...
    <div class="none sended-request">
        <h2 class="request-sended">Заявка отправлена</h2>
    </div>
</div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.corporate__submit').click(function (event) {
                ...
                if($form.find('input[name="guest"]').val() < 0) {
                    console.log($form.find('input[name="guest"]'));
                    return false;
